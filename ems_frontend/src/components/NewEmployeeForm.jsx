    ...
    <div className="flex items-center justify-center bg-gray-100 dark:bg-gray-900">
      {
        ...
        role === ROLES.ROLE_MANAGER && authorities.includes(PERMISSIONS.EMPLOYEE_CREATE) && (
          <div className="bg-white min-h-[700px] dark:bg-gray-800 rounded-lg shadow-lg py-4 px-6 w-full max-w-6xl">
